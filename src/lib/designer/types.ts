...
export const DESIGN_TEMPLATES: DesignTemplate[] = [
    {
        ...
        category: 'social',
        nodes: [
            { id: 'client-1', type: 'architecture', position: { x: 50, y: 200 }, data: { type: 'web-client', label: 'Web Client', icon: '🌐', color: '#64748b', category: 'client', config: {} } },
            { id: 'lb-1', type: 'architecture', position: { x: 350, y: 200 }, data: { type: 'load-balancer', label: 'Load Balancer', icon: '⚖️', color: '#22c55e', category: 'infrastructure', config: {} } },
            { id: 'api-1', type: 'architecture', position: { x: 700, y: 80 }, data: { type: 'api-server', label: 'API Server', icon: '🔌', color: '#3b82f6', category: 'server', config: {} } },
            { id: 'api-2', type: 'architecture', position: { x: 700, y: 320 }, data: { type: 'api-server', label: 'API Server', icon: '🔌', color: '#3b82f6', category: 'server', config: {} } },
            { id: 'redis-1', type: 'architecture', position: { x: 1050, y: 80 }, data: { type: 'redis', label: 'Redis Cache', icon: '⚡', color: '#dc382d', category: 'database', config: {} } },
            { id: 'postgres-1', type: 'architecture', position: { x: 1050, y: 320 }, data: { type: 'postgres', label: 'PostgreSQL', icon: '🐘', color: '#336791', category: 'database', config: {} } },
        ],
        edges: [
    ...
    },
    {
        ...
        category: 'streaming',
        nodes: [
            { id: 'client-1', type: 'architecture', position: { x: 50, y: 250 }, data: { type: 'web-client', label: 'Web Client', icon: '🌐', color: '#64748b', category: 'client', config: {} } },
            { id: 'cdn-1', type: 'architecture', position: { x: 400, y: 50 }, data: { type: 'cdn', label: 'CDN', icon: '🌍', color: '#f97316', category: 'cache', config: {} } },
            { id: 'gateway-1', type: 'architecture', position: { x: 400, y: 450 }, data: { type: 'api-gateway', label: 'API Gateway', icon: '🚪', color: '#a855f7', category: 'infrastructure', config: {} } },
            { id: 'api-1', type: 'architecture', position: { x: 750, y: 250 }, data: { type: 'api-server', label: 'API Server', icon: '🔌', color: '#3b82f6', category: 'server', config: {} } },
            { id: 'cache-1', type: 'architecture', position: { x: 1100, y: 50 }, data: { type: 'cache-layer', label: 'Cache Layer', icon: '💾', color: '#f59e0b', category: 'cache', config: {} } },
            { id: 'db-1', type: 'architecture', position: { x: 1100, y: 250 }, data: { type: 'cassandra', label: 'Cassandra', icon: '📊', color: '#1287b1', category: 'database', config: {} } },
            { id: 'queue-1', type: 'architecture', position: { x: 1100, y: 450 }, data: { type: 'message-queue', label: 'Message Queue', icon: '📨', color: '#ec4899', category: 'infrastructure', config: {} } },
        ],
        edges: [
    ...
    },
    {
        ...
        nodes: [
            { id: 'client-1', type: 'architecture', position: { x: 50, y: 250 }, data: { type: 'web-client', label: 'Web Client', icon: '🌐', color: '#64748b', category: 'client', config: {} } },
            { id: 'lb-1', type: 'architecture', position: { x: 350, y: 250 }, data: { type: 'load-balancer', label: 'Load Balancer', icon: '⚖️', color: '#22c55e', category: 'infrastructure', config: {} } },
            { id: 'api-1', type: 'architecture', position: { x: 700, y: 50 }, data: { type: 'microservice', label: 'Product Service', icon: '🔷', color: '#06b6d4', category: 'server', config: {} } },
            { id: 'api-2', type: 'architecture', position: { x: 700, y: 250 }, data: { type: 'microservice', label: 'Order Service', icon: '🔷', color: '#06b6d4', category: 'server', config: {} } },
            { id: 'api-3', type: 'architecture', position: { x: 700, y: 450 }, data: { type: 'microservice', label: 'User Service', icon: '🔷', color: '#06b6d4', category: 'server', config: {} } },
            { id: 'db-1', type: 'architecture', position: { x: 1050, y: 50 }, data: { type: 'postgres', label: 'PostgreSQL', icon: '🐘', color: '#336791', category: 'database', config: {} } },
            { id: 'db-2', type: 'architecture', position: { x: 1050, y: 250 }, data: { type: 'mongodb', label: 'MongoDB', icon: '🍃', color: '#47a248', category: 'database', config: {} } },
            { id: 'cache-1', type: 'architecture', position: { x: 1050, y: 450 }, data: { type: 'redis', label: 'Redis', icon: '⚡', color: '#dc382d', category: 'database', config: {} } },
        ],
        edges: [
            { id: 'e1', source: 'client-1', target: 'lb-1' },
            { id: 'e2', source: 'lb-1', target: 'api-1' },
    ...
    },
    {
        ...
        nodes: [
            { id: 'mobile-1', type: 'architecture', position: { x: 50, y: 250 }, data: { type: 'mobile-client', label: 'Mobile App', icon: '📱', color: '#000000', category: 'client', config: {} } },
            { id: 'gateway-1', type: 'architecture', position: { x: 400, y: 250 }, data: { type: 'api-gateway', label: 'API Gateway', icon: '🚪', color: '#a855f7', category: 'infrastructure', config: {} } },
            { id: 'dispatch-1', type: 'architecture', position: { x: 750, y: 50 }, data: { type: 'microservice', label: 'Dispatch Service', icon: '🚕', color: '#06b6d4', category: 'server', config: {} } },
            { id: 'pricing-1', type: 'architecture', position: { x: 750, y: 250 }, data: { type: 'microservice', label: 'Pricing Service', icon: '💰', color: '#06b6d4', category: 'server', config: {} } },
            { id: 'driver-1', type: 'architecture', position: { x: 750, y: 450 }, data: { type: 'microservice', label: 'Driver Service', icon: '👤', color: '#06b6d4', category: 'server', config: {} } },
            { id: 'geo-1', type: 'architecture', position: { x: 1100, y: 50 }, data: { type: 'cassandra', label: 'Geo Database', icon: '🗺️', color: '#1287b1', category: 'database', config: {} } },
            { id: 'redis-1', type: 'architecture', position: { x: 1100, y: 250 }, data: { type: 'redis', label: 'Redis Cache', icon: '⚡', color: '#dc382d', category: 'database', config: {} } },
            { id: 'postgres-1', type: 'architecture', position: { x: 1100, y: 450 }, data: { type: 'postgres', label: 'PostgreSQL', icon: '🐘', color: '#336791', category: 'database', config: {} } },
            { id: 'queue-1', type: 'architecture', position: { x: 750, y: 650 }, data: { type: 'message-queue', label: 'Event Bus', icon: '📨', color: '#ec4899', category: 'infrastructure', config: {} } },
        ],
        edges: [
